...
In order to deploy Github Action, you need to create a folder ***'.github/workflows'*** at your root repository. Then into a file called ***'hugo.yaml'*** you can paste the following code.
